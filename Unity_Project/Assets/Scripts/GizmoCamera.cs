    ...
    public class GizmoCamera : MonoBehaviour
    {
        ...
        private void OnGUI()
        {
            if (guiInstructions)
            {
                ...
                Rect rect = new Rect(Screen.width * 0.5f - 100, Screen.height * 0.5f - 60, 200, 20);
                rect.position += Vector2.right * 35;
                GUI.Label(rect, "Instructions");
                rect.position += Vector2.up * 20 - Vector2.right * 30;
                GUI.Label(rect, "Left Mouse Button - Create point");
                ...
                rect.position += Vector2.up * 20;
                GUI.Label(rect, "Z - Remove last point");
            }
        }
